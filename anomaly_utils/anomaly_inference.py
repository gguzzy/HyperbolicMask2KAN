...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        default="/home/shyam/MAD/configs/cityscapes/semantic-segmentation/test_unk_na.yaml",
        metavar="FILE",
        help="path to config file",
    )
    parser.add_argument(
        "--input",
        default="/home/shyam/MAD/unk-eval/RoadObsticle21/images/*.webp",
        nargs="+",
    ...
    parser.add_argument(
        "--output",
        default="/home/shyam/MAD/unk-eval/results/",
