...
def add_maskformer2_config(cfg):
    ...
    # Lovasz loss
    cfg.MODEL.MASK_FORMER.LOVASZ_WEIGHT = 1.0
    cfg.MODEL.MASK_FORMER.LOVASZ_FINETUNE = False
    cfg.MODEL.MASK_FORMER.LOVASZ_LOSS = True

    # Contrastive loss
    cfg.MODEL.MASK_FORMER.CONTRASTIVE_WEIGHT = 1.0
    cfg.MODEL.MASK_FORMER.CONTRASTIVE_FINETUNE = False
    cfg.MODEL.MASK_FORMER.CONTRASTIVE_LOSS = True

    # CrossEntropy loss
    cfg.MODEL.MASK_FORMER.CROSS_WEIGHT = 1.0
    cfg.MODEL.MASK_FORMER.CROSS_FINETUNE = False
    cfg.MODEL.MASK_FORMER.CROSS_LOSS = True

    # ood finetune
    cfg.MODEL.MASK_FORMER.ANOMALY_TASK_OOD = False
    ...
    cfg.MODEL.MASK_FORMER.ANOMALY_FILEPATH = "/home/gianluca/PycharmProjects/benchmark_loss/Mask2Former/datasets/cityscapes/coco/ood_annotations/*.png"  #Change Path
