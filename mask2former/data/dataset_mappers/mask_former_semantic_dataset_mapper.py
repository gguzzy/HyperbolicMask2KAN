...
class MaskFormerSemanticDatasetMapper:
    ...
    def from_config(cls, cfg, is_train=True):
        ...
        ret = {
            ...
            "is_anomaly_task": cfg.MODEL.MASK_FORMER.ANOMALY_TASK_OOD,
    ...
    def __call__(self, dataset_dict):
        ...
        #Anomaly Mix#
        if self.is_ood_ft or self.is_anomaly_task:
            if np.random.uniform() < self.anomaly_mix_ratio:
                ...
                image, sem_seg_gt = mix_object(current_labeled_image=image_copy, current_labeled_mask=sem_seg_gt, cut_object_image=coco_img, cut_object_mask=coco_gt)
