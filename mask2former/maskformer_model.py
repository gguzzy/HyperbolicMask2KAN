...
class MaskFormer(nn.Module):
    ...
    def __init__(
        ...
        self.ood_ft = ood_ft
        self.lovasz_ft = lovasz_ft
        self.contrastive_ft = contrastive_ft
        self.crossentropy_ft = crossentropy_ft
        self.densehybrid = densehybrid
    ...
    def from_config(cls, cfg):
        ...
        lovasz_weight = cfg.MODEL.MASK_FORMER.LOVASZ_WEIGHT
        dense_weight = cfg.MODEL.MASK_FORMER.DENSE_HYBRID_WEIGHT
        ...
        weight_dict = {"loss_ce": class_weight, "loss_mask": mask_weight, "loss_dice": dice_weight,
                       "loss_ood": ood_weight, "loss_lovasz": lovasz_weight, "densehybrid_loss": dense_weight}
        ...
        # Aggiungiamo Lovasz loss se disponibile
        if cfg.MODEL.MASK_FORMER.LOVASZ_FINETUNE:
            # losses.append("lovasz")
            pass

        # # Aggiungiamo Lovasz loss se disponibile
        # if cfg.MODEL.MASK_FORMER.CROSS_FINETUNE:
        #     losses.append("crossentropy")
        #
        # # Aggiungiamo Lovasz loss se disponibile
        # if cfg.MODEL.MASK_FORMER.CONTRASTIVE_FINETUNE:
        #     losses.append("contrastive")

        # Aggiungiamo Lovasz loss se disponibile
        if cfg.MODEL.MASK_FORMER.CONTRASTIVE_FINETUNE:
            losses.append("densehybrid")
        ...
        criterion = SetCriterion(
            ...
            lovasz_loss=cfg.MODEL.MASK_FORMER.LOVASZ_LOSS,
        ...
        return {
            ...
            "lovasz_ft": cfg.MODEL.MASK_FORMER.LOVASZ_FINETUNE,
            "contrastive_ft": cfg.MODEL.MASK_FORMER.CONTRASTIVE_FINETUNE,
            "crossentropy_ft": cfg.MODEL.MASK_FORMER.CROSS_FINETUNE,
            "densehybrid": cfg.MODEL.MASK_FORMER.DENSE_HYBRID_LOSS,
            # inference
