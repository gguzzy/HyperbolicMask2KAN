...
class SetCriterion(nn.Module):
    ...
    def loss_lovasz(self, outputs, targets, indices, num_masks):
        ...
        losses = {
            "loss_lovasz": lovasz_hinge(point_logits, point_labels, per_image=True) # necessaria qui perchè su segmentazione immagine
        }
